...
class Token(models.Model):
    ...
    tb_key = models.CharField(max_length=15, verbose_name='Text + Berg No') #Text+Berg Token id: article-sentence-token
...
class GeoCoordinates(models.Model):
    ...
    type = models.CharField(max_length=3, choices=(('ST', 'Swisstopo'), ('WGS', 'WGS_84'),  ('NO', 'None')), default='NO')
...
class GeoLocationReference(models.Model):
    ...
    type = models.CharField(max_length=2, choices=(('ST', 'Swisstopo'), ('GN', 'GeoNames'),  ('OT', 'Other'), ('NO', 'None')), default='NO')
...
class GeoLocation(models.Model):
    ...
    type = models.CharField(max_length=2, choices=(('MO', 'Mountain'), ('GL', 'Glacier'), ('PL', 'Place'), ('RI', 'River'), ('LA', 'Lake'), ('VL', 'Valley'), ('MC', 'Mountain Cabin'), ('MS', 'Misc')))
